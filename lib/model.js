...
var Instance = function(json) {
  ...
  instance.png_update_time = undefined;
  instance.display = undefined;
  ...
  if (json != undefined) {
    ...
    instance.png_update_time = json.png_update_time;
    instance.display = json.display;
  }
}
...
Instance.prototype.toJSON = function() {
  ...
  json.png_update_time = instance.png_update_time;
  json.display = instance.display;
...
Instance.prototype.needsUpdate = function() {
  var instance = this;

  var now = Date.now();
  var tenMin = 1000 * 60 * 10;

  return (this.update_time == undefined || instance.update_time + tenMin < now);
}
  ...
  if (instance.needsUpdate()) {
    ks.pledged(instance.project_url, function(err, pledged) {
      if (err) {
        ...
        instance.percent = (((100) / instance.goal) * instance.raised)
          .toFixed(2);
